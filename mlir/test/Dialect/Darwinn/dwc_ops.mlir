...
func.func @test_dynamic_slice(%arg0: tensor<4xf32>) -> tensor<4xf32> {
  ...
  %0 = "dwc.dynamic_slice"(%arg0) {mode = 0 : i64, read_location = #dwc.memory_location<TILE_SRAM>, slice_size = 4 : i64} : (tensor<4xf32>) -> tensor<4xf32>
  return %0 : tensor<4xf32>
}
...
func.func @test_dynamic_update_slice(%arg0: tensor<4xf32>) -> tensor<4xf32> {
  ...
  %0 = "dwc.dynamic_update_slice"(%arg0) {mode = 0 : i64, write_location = #dwc.memory_location<HOST_DRAM>} : (tensor<4xf32>) -> tensor<4xf32>
  return %0 : tensor<4xf32>
}
